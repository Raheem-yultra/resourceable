...
const REVIEW_POOL = [
  ...
  { rating: 5, title: 'Worth every penny', content: 'Warm, professional, and genuinely skilled with special needs kids. They send clear progress notes after every session and always follow up when we have questions.' },
...
const PROVIDERS = [
  ...
  },
  {
    ...
    display: 'comfortfit',
    description: 'Clothing engineered for real bodies and real sensory needs: flat seams, tag-free everything, magnetic closures, and abdominal-access designs. Designed with input from a parent advisory board of 200+ special needs families.',
  ...
  },
  {
    ...
    description: 'A parent-founded nonprofit running support groups, workshops, and community programs for special needs families across the Valley. Most programs are free, childcare is provided at in-person events, and everyone is welcome exactly as they are.',
